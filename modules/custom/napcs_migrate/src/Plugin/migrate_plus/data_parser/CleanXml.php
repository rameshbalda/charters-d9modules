...
namespace Drupal\napcs_migrate\Plugin\migrate_plus\data_parser;
 ...
 *
 * An exact copy of Xml.php from migrate_plus except for the line removing
 * chr(3) in openSourceUrl().
 *
 * @DataParser(
 *   id = "clean_xml",
 ...
 * )
 */
class CleanXml extends DataParserPluginBase {
  ...
  protected function openSourceUrl($url) {
    ...
    return $this->reader->xml($data, NULL, \LIBXML_NOWARNING);
  }
